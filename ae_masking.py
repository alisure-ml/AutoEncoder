...
class Runner:
    ...
    def save_result(self, file_name, n_show=10):
        ...
        # 对比原始图片重建图片
        tools.gaussian_save_result(images, masking_images, decode, save_path="result/ae-masking2/{}.jpg".format(file_name))
        pass

    pass

if __name__ == '__main__':
    runner = Runner(autoencoder=MaskingAutoEncoder(n_input=784, n_hidden=200))
    runner.train()
